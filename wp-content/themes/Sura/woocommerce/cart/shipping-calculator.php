...
<form class="shipping_calculator form-select" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button btn btn-default"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
